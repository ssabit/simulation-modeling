...
Original file is located at
    https://colab.research.google.com/drive/1z4teQVomd-SbXGK7Onw4Xas9YzkdRFxu
"""
...
class SSQ:
  def __init__(self,option):   #Initialization
    ...
    #self.interarrivals= list(np.random.exponential(1.2,50))
    #self.service_times= list(np.random.exponential(1.3, 50))
